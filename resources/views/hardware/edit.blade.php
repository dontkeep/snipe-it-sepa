...
@section('inputFields')
  ...
  <div class="form-group {{ $errors->has('asset_tag') ? ' has-error' : '' }}">
    ...
    @if (!$item->id)
        ...
        @include ('partials.forms.edit.location-select', ['translated_name' => trans('admin/hardware/form.checkout_to'), 'fieldname' => 'assigned_location', 'style' => 'display:none;', 'required' => 'true'])
    @endif
